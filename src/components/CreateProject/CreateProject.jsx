      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {platforms.map(platform => (
          <div
            ...
            className={`relative bg-[#161b22] border-2 rounded-xl p-6 cursor-pointer transition ${
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className={`px-4 py-3 rounded-lg border-2 transition ${
                    configs.android.language === 'kotlin'
                      ? 'border-[#58a6ff] bg-[#58a6ff]/10 text-white'
                      : 'border-[#30363d] text-[#8b949e] hover:border-[#58a6ff]/50'
                  }`}
                >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className={`px-4 py-3 rounded-lg border-2 transition ${
                    configs.ios.language === 'objective-c'
                      ? 'border-[#58a6ff] bg-[#58a6ff]/10 text-white'
                      : 'border-[#30363d] text-[#8b949e] hover:border-[#58a6ff]/50'
                  }`}
                >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className={`px-4 py-3 rounded-lg border-2 transition ${
                    configs.web.database === 'postgresql'
                      ? 'border-[#58a6ff] bg-[#58a6ff]/10 text-white'
                      : 'border-[#30363d] text-[#8b949e] hover:border-[#58a6ff]/50'
                  }`}
                >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`px-4 py-3 rounded-lg border-2 transition ${
                    configs.web.cssFramework === 'tailwind'
                      ? 'border-[#58a6ff] bg-[#58a6ff]/10 text-white'
                      : 'border-[#30363d] text-[#8b949e] hover:border-[#58a6ff]/50'
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-4 py-3 rounded-lg border-2 transition ${
                    configs.web.cssFramework === 'bootstrap'
                      ? 'border-[#58a6ff] bg-[#58a6ff]/10 text-white'
                      : 'border-[#30363d] text-[#8b949e] hover:border-[#58a6ff]/50'
                  }`}
                >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`px-4 py-3 rounded-lg border-2 transition ${
                    configs.desktop.framework === 'electron'
                      ? 'border-[#58a6ff] bg-[#58a6ff]/10 text-white'
                      : 'border-[#30363d] text-[#8b949e] hover:border-[#58a6ff]/50'
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-4 py-3 rounded-lg border-2 transition ${
                    configs.desktop.framework === 'tauri'
                      ? 'border-[#58a6ff] bg-[#58a6ff]/10 text-white'
                      : 'border-[#30363d] text-[#8b949e] hover:border-[#58a6ff]/50'
                  }`}
                >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`px-4 py-3 rounded-lg border-2 transition ${
                    configs.template.cssFramework === 'tailwind'
                      ? 'border-[#58a6ff] bg-[#58a6ff]/10 text-white'
                      : 'border-[#30363d] text-[#8b949e] hover:border-[#58a6ff]/50'
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-4 py-3 rounded-lg border-2 transition ${
                    configs.template.cssFramework === 'bootstrap'
                      ? 'border-[#58a6ff] bg-[#58a6ff]/10 text-white'
                      : 'border-[#30363d] text-[#8b949e] hover:border-[#58a6ff]/50'
                  }`}
                >
